	...
	<div class="collapse show" id="collapseCardExample">
		...
		<form id="frm" action="/register/register05" method="post">
			<div class="mb-3">
			  ...
			  <input type="text" class="form-control" name="userId" id="userId" placeholder="userId" value="a001" required>
			</div>
			<div class="mb-3">
			  <label for="exampleFormControlTextarea1" class="form-label">password</label>
			  <input type="password" class="form-control" name="password" id="password" placeholder="password" value="java" required>
<!-- 			  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea> -->
			</div>
			<div class="mb-3">
			  <label for="exampleFormControlTextarea1" class="form-label">coin</label>
			  <input type="text" class="form-control" name="coin" id="coin" placeholder="coin" value="100" required>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
			  ...
			  <p>
				<select name="nationality" class="form-select" aria-label="Default select example">
				  ...
				  <option value="austalia">호주</option>
				</select>
			   </p>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
			  <label for="exampleFormControlTextarea1" class="form-label">marriaged</label>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           <div class="p-5">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <a id="btnZipCode" class="btn btn-info btn-icon-splite">
	           ...
	           <div class="col-lg-6">
	           		<div class="card mb-4 py-3 border-left-primary">
	                    <div class="card-body">
	                       	...
	                       	유효년월 : <input type="date" class="form-control form-control-user" name="cardVOList[0].validMonth" id="validMonth1" placeholder="validMonth"/>
	                    </div>
	                </div>
                </div>
	           <div class="col-lg-6">
	           		<div class="card mb-4 py-3 border-left-primary">
	                    <div class="card-body">
	                       	...
	                       	유효년월 : <input type="date" class="form-control form-control-user" name="cardVOList[1].validMonth" id="validMonth1" placeholder="validMonth"/>
	                    </div>
	                </div>
                </div>
         	</div>
