...
//	private MultipartFile picture2;
	...
	public String toString() {
		return "ExamMemberVO [memId=" + memId + ", memName=" + memName + ", memJob=" + memJob + ", memLike=" + memLike
				...
				+ introduction + ", pictureList=" + pictureList + ", pictureArray=" + Arrays.toString(pictureArray)
				+ ", coin=" + coin + ", birth=" + birth + ", gender=" + gender + ", nationality=" + nationality
				+ ", cars=" + Arrays.toString(cars) + ", car=" + car + ", hobbyList=" + Arrays.toString(hobbyList)
				+ ", hobby=" + hobby + ", marriaged=" + marriaged + ", addressVO=" + addressVO + ", cardVOList="
				+ cardVOList + ", developer=" + developer + ", foreigner=" + foreigner + ", attachVOList="
				+ attachVOList + "]";
	}
