	...
	<div class="container"> 
		<div class="row" >
			<div class="col">
				...
				<p>
				<form name="addForm" action="/addCart?id=${bookVO.bookId}" method="post">
				...
				<img alt="${bookVO.name}" title="${bookVO.name}" src="/resources/images/${bookVO.filename}" style="width: 50%; height: 400px">
		</div>
	</div>
