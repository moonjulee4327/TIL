...
<nav class="navbar navbar-expand navbar-dark bg-dark">
	...
	<div class="container">
		...
		<div style="float: right;">
			<!-- 인증된 사용자인 경우 true 로그인 했을 경우만 로그아웃 버튼이 보임 -->
			<sec:authorize access="isAuthenticated()">
				<form action="/logout" method="post">
					<button type="submit" class="btn btn-danger">로그아웃</button>
					<sec:csrfInput/>
				</form>
				<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">나의 정보 보기</button>
			</sec:authorize>
		</div>
	</div>
</nav>
...
<!-- 
	...
	- button의  data-bs-toggle 속성을 "modal"로 설정 해야함
	- data-bs-target 속성은 출력할 modal div 객체의 id를 넣어줌
